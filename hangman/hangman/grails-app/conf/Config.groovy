...
environments {
    development {
		...
		grails.serverURL = "http://localhost:8080/hangman"
    }
    production {
        grails.logging.jul.usebridge = false
        grails.serverURL = "http://hangman-env.elasticbeanstalk.com"
    }
}
...
// Required
grails.plugin.facebooksdk.app.id = 751005798339220
grails.plugin.facebooksdk.app.permissions = ['email','public_profile', 'user_friends']
grails.plugin.facebooksdk.app.secret = '537ddd406651798ae67cdfc326b40781'
