...
class gsp_facebookSdk_tags_logout_link_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/facebook-sdk-2.5.0/grails-app/views/tags/_logout-link.gsp" }
public Object run() {
Writer out = getOut()
