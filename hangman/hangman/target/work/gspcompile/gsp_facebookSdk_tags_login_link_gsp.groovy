...
class gsp_facebookSdk_tags_login_link_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/facebook-sdk-2.5.0/grails-app/views/tags/_login-link.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
expressionOut.print(appPermissions instanceof List ? appPermissions.join(',') : appPermissions)
printHtmlPart(9)
if(true && (callback)) {
printHtmlPart(10)
