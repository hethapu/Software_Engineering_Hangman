...
class gsp_facebookSdk_tags_publish_link_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/facebook-sdk-2.5.0/grails-app/views/tags/_publish-link.gsp" }
public Object run() {
Writer out = getOut()
...
if(true && (caption)) {
printHtmlPart(11)
expressionOut.print(caption.encodeAsHTML())
printHtmlPart(5)
}
printHtmlPart(10)
if(true && (display)) {
...
if(true && (description)) {
printHtmlPart(13)
expressionOut.print(description.encodeAsHTML())
printHtmlPart(5)
}
printHtmlPart(10)
if(true && (link)) {
...
if(true && (name)) {
printHtmlPart(15)
expressionOut.print(name.encodeAsHTML())
printHtmlPart(5)
}
printHtmlPart(10)
if(true && (picture)) {
